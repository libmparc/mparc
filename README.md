...
> Also this can be built with the old makefile (Makefile.dumb) (trust me), autotools (Less broken, but still yes) or CMake (it works, just do it in the build/ directory).